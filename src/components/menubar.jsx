    ...
    return (
        <>
            <nav className="flex justify-between text-white w-screen">
                <div className="px-5 xl:px-12 py-6 flex w-full items-center">
                    <a className="text-3xl font-bold font-heading" href="#">
                        <div className="logo_icon">
                            <StylizeoIcon className="h-9 logo_icon" />
                        </div>
                ...
                <a className="xl:hidden flex mr-3 items-center" href="#">
                ...
                <a className="xl:hidden flex items-center mr-4 hover:text-gray-200" href="#">
                    <DefaultAva />
                </a>
                <a className="navbar-burger self-center mr-8 xl:hidden" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
